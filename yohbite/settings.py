"""
Django settings for yohbite project.
...
WSGI_APPLICATION = 'yohbite.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'yohbiteapp.social_auth_pipeline.create_user_by_type',  # <--- set the path to the function
