...
urlpatterns = [
                  ...
                  url(r'^shop/sign-in/$', auth_views.LoginView.as_view(template_name='restaurant/sign_in.html'),
                      name='restaurant-sign-in'),
                  url(r'^shop/sign-up/$', views.restaurant_sign_up,
                      name='restaurant-sign-up'),
                  url(r'^shop/sign-out/$', auth_views.LogoutView.as_view(),
                      name='restaurant-sign-out'),
                  url(r'^shop/$', views.restaurant_home, name='restaurant-home'),

                  url(r'^shop/account/$', views.restaurant_account, name='restaurant-account'),
                  url(r'^shop/item/$', views.restaurant_meal, name='restaurant-meal'),
                  url(r'^shop/item/add/$', views.restaurant_add_meal, name='restaurant-add-meal'),
                  ...
                  url(r'^api/shop/order/notification/(?P<last_request_time>.+)/$',
